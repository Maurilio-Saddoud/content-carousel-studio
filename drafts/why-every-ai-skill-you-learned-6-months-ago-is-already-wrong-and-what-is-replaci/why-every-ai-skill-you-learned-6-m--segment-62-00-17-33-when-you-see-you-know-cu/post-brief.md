...
Carousel slug: why-every-ai-skill-you-learned-6-m--segment-62-00-17-33-when-you-see-you-know-cu
Status: draft carousel created automatically
Primary source segment: segment-62 (00:17:33 → 00:17:46)

## Default output
This ingest run created a previewable draft carousel at `carousels/why-every-ai-skill-you-learned-6-m--segment-62-00-17-33-when-you-see-you-know-cu/carousel.md`.
Its source artifacts still live under `sources/why-every-ai-skill-you-learned-6-months-ago-is-already-wrong-and-what-is-replaci/`.
...
- Raw hook: February and the person whose boundary sense was current last August are operating worlds apart.

## Primary source text

> February and the person whose boundary sense was current last August are operating worlds apart. This is really the mechanism behind those gigantic leverage numbers that keep appearing in production deployments. When you see, you know, cursor hitting stunning numbers with a small number of people
...
### segment-78: I've seen two structures emerging here that are significant, right?
